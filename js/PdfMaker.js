app.service('PdfMaker', [function() {
    ...
    this.createChart = function(personalDetailsObject, assetsObject, liabilitiesObject, otherExpenses, existingCovers, assumptions, resultS1, resultS2, buyOption, wp) {
        ...
        var gender = personalDetailsObject.genderOption ? "Male" : "Female";

        var spouse = personalDetailsObject.spouseOption ? "Yes" : "No";
        ...
        var rows1 = [
            { "info": "Full Name", "value": reduceToCapitalize((personalDetailsObject.firstName.trim() + " " + personalDetailsObject.lastName.trim()).split(' ')) },
            { "info": "E-Mail", "value": personalDetailsObject.email.trim() },
            { "info": "Mobile Number", "value": "0" + personalDetailsObject.mobile },
            { "info": "Date Of Birth", "value": cdob },
            { "info": "Age", "value": personalDetailsObject.age },
        ...
        if (personalDetailsObject.postalCode != undefined) {
            ...
            if (personalDetailsObject.postalCode < 10) {
                postCode = "000" + personalDetailsObject.postalCode
            }
            if (personalDetailsObject.postalCode >= 10 && personalDetailsObject.postalCode < 100) {
                postCode = "00" + personalDetailsObject.postalCode
            }
            if (personalDetailsObject.postalCode >= 100 && personalDetailsObject.postalCode < 1000) {
                postCode = "0" + personalDetailsObject.postalCode
            }
