...
this.createChart = function(dob,age,fy,resultS1,resultS2,toggleNeeded){
  ...
  if(true){
    ...
    { "name": "Current Salary Exclude Super", "country": moneyFormat.to(Number(resultS1.trauma.replace('$','').replaceAll(',','')))},
    ...
    { "name": "Desired Minimum Take Home Salary Per Annum", "country":moneyFormat.to(Number(resultS1.trauma.replace('$','').replaceAll(',','')))},
